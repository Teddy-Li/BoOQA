...
--which_positives "$which_positives" --global_presence "$global_presence" --wordnet_dir ../clue_aux_data/wn-cmn-lmf.xml \
--wsd_model_dir XXX --word2vec_path ../clue_aux_data/sgns.merge.char --all_triples_path ../../entGraph_3/clue_typed_triples_tacl.json \
...
--pred_set_path ../clue_inter_data/clue_all_pred_set.json --pred_vectors_path ../clue_inter_data/clue_triple_vectors.h5 \
--pred_vectors_cache_size 300000 --global_presence_thres "$global_presence_thres" --global_presence_cap "$global_presence_cap" \
