...
python -u generate_negatives.py --do_final_sampling --positives_base nc_positives_%s_%s.json \
...
--word2vec_path glove.840B.300d.txt --all_triples_path ../news_genC_GG_typed.json --wsd_batch_size 32 \
--partition_triples_path ./nc_time_slices/nc_typed_triples_%s_%s.json --triple_set_path ./nc_all_triple_set.json \
--pred_set_path ./nc_all_pred_set.json --pred_vectors_path ./nc_triple_vectors.h5 --pred_vectors_cache_size 300000 \
...
--final_samples_base_fn nc_final_samples_%s_%d_%d_%d_%d_%s_%s_%.1f_%s.json --lang en ${flag1}
