...
python -u generate_negatives.py --do_final_sampling_freq_map --positives_base clue_positives_%s_%s.json \
...
--word2vec_path ./sgns.merge.char --all_triples_path ../entGraph_3/clue_typed_triples_tacl.json \
...
--final_samples_base_fn clue_final_samples_%s_%d_%d_%d_%d_%s_%s_%.1f_freqmap_%s.json --lang zh ${flag1}
