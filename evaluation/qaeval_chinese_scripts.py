...
if __name__ == '__main__':
	...
	parser.add_argument('--prem_selection', type=str, default=None, help='[scattered / topk / None]')
	parser.add_argument('--small_memory', action='store_true')
	...
	assert args.smooth_p is None or args.smooth_p in ['lm', 'wn_hypernym', 'wn_hyponym']
	assert args.smooth_h is None or args.smooth_h in ['lm', 'wn_hypernym', 'wn_hyponym']
