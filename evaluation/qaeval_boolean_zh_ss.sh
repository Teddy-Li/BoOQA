...
--eval_method ss --eg_root XXX --eg_name XXX --eg_suff XXX --eg_feat_idx 1 \
--max_spansize 80 --result_dir ./results/qaeval_results_prd/%s_%s/ --backupAvg --device_name "$device_name" \
--min_graphsize 20480 --max_context_size 1000 --bert_dir "$bert_dir" --batch_size "$batch_size" \
